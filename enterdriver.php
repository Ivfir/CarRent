 ...
 <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Ներմուծեք վարորդի տվյալները </h3>

          <div class="form-group">
            <input type="text" class="form-control" id="driver_name" name="driver_name" placeholder="Վարորդի անուն " required autofocus="">
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="dl_number" name="dl_number" placeholder="Վարորդի վարորդականի համար" required>
          </div>     

          <div class="form-group">
            <input type="text" class="form-control" id="driver_phone" name="driver_phone" placeholder="Հեռախոսահամար" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="driver_address" name="driver_address" placeholder="Հասցե" required>
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="driver_gender" name="driver_gender" placeholder="Սեռ" required>
          </div>

           <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> Ավելացնել վարորդ</button>    
        </form>
      </div>
    </div>
    ...
    <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Իմ վարորդները</h3>
<?php
// Storing Session
...
if (mysqli_num_rows($result) > 0) {
  ...
  <h4><center>Վարորդներ չկան</center> </h4>
