...
<div class="container">
      <div class="jumbotron">
        ...
        <p class="text-center"> Հուսով ենք հավանեցիք մեր ծառայությունը </p>
      </div>
    </div>
...
<tr>
<th width="15%">Ավտոմեքենա</th>
<th width="15%">Վարձույթի սկիզբ</th>
<th width="15%">Վարձույթի ավարտ</th>
<th width="10%">Արժեք</th>
<th width="15%">Հեռավորություն (kms)</th>
<th width="15%">Օրերի քանակ</th>
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Դուք մինչ այժմ ոչ մի մեքենա չեք վարձել:</h1>
        <p class="text-center">Խնդրում ենք վարձակալել մեքենաներ՝ ձեր տվյալները այստեղ տեսնելու համար: </p>
      </div>
    </div>
