        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="customerlogin.php">Հաճախրդ</a>
                    </li>
                    <li>
                        <a href="#"> ՀՏՀ </a>
                    </li>
...
?></td>
<td><a href="returncar.php?id=<?php echo $row["id"];?>"> Վերադարձնել </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
        <?php } else {
            ...
            <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">Վերադարձելու մեքենաներ չկան</h1>
        <p class="text-center"> Հուսով ենք հավանեցիք մեր ծառայությունը </p>
      </div>
    </div>
